...
function Header() {
    return (
        <header className='bg-indigo-600 pt-10 pb-6'>
            ...
            <nav className='flex flex-row justify-around gap-16 pl-4 pr-4'>
               ...
               <div className='text-indigo-800 px-4 py-2 hover:bg-violet-200 cursor-pointer font-semibold text-2xl rounded-full bg-violet-100 shadow-md'>+7 (960) 587-53-58</div>
               </div>
